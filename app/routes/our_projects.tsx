...
const projects = [
  ...
  {
    id: 5,
    name: "SDS — Smart Delivery System",
    emoji: "📦",
    description:
      "A portable, real-time IoT monitoring system designed to safeguard the food supply chain during distribution. By integrating advanced hardware and software, this device ensures food freshness by continuously tracking ambient temperature and precise location transit data.",
    links: [],
    tags: ["IoT", "ESP32-C3", "Flutter", "MQTT"],
  },
];
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  {project.links.length === 0 && (
                    <span className="inline-block text-xs font-semibold text-gray-400 bg-gray-100 rounded-full px-3 py-1">
                      Mobile App · Available on request
                    </span>
                  )}
                </div>
              </div>
